        ...
        if (document.querySelector(".accordion-container")) new accordion_min(".accordion-container", {
            ...
            beforeOpen: e => {
                ...
                setTimeout((function setSpace() {
                    ...
                    if (padding != maxValue) setTimeout(setSpace, operationTime);
                }), operationTime);
            },
            beforeClose: e => {
                let header = e.querySelector(".accordion__header");
                ...
                setTimeout((function setSpace() {
                    padding -= diff;
                    header.style.paddingBottom = `${padding}px`;
                    if (padding != 0) setTimeout(setSpace, operationTime);
                }), operationTime);
            }
        });
...
*/
        ...
        function LottieScrollTrigger(vars) {
            let playhead = {
                frame: 0
            }, target = gsapWithCSS.utils.toArray(vars.target)[0], speeds = {
                slow: "+=2000",
                medium: "+=1000",
                fast: "+=500"
            }, st = {
                ...
                scrub: 1
            }, ctx = gsapWithCSS.context && gsapWithCSS.context(), animation = lottie.loadAnimation({
                container: target,
            ...
            animation.addEventListener("DOMLoaded", (function() {
                ...
                ScrollTrigger_ScrollTrigger.sort();
        ...
        async function initLottie() {
            if (window.innerWidth > 767.98) {
                let tl = gsapWithCSS.timeline({
                    onComplete: () => LottieScrollTrigger({
                        target: "#animation-layout",
                        trigger: ".start",
                        start: "top-=300px top",
                        endTrigger: ".end",
                        end: "bottom-=105px bottom-=280px",
                        pin: "#animation-layout",
                        pinSpacing: true,
                ...
                const promise = new Promise((resolve => {
                    const firstAnim = lottie.loadAnimation({
                        container: gsapWithCSS.utils.toArray(`#animation-mobile-0`)[0],
                        renderer: "svg",
                        loop: false,
                        autoplay: false,
                        path: `./files/lottie/data-01.json`,
                        rendererSettings: {
                            preserveAspectRatio: "xMidYMid slice"
                        }
                    });
